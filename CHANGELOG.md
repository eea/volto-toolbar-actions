...
### [3.0.1](https://github.com/eea/volto-toolbar-actions/compare/3.0.0...3.0.1) - 8 April 2026

#### :hammer_and_wrench: Others

- test: Fix make test [Alin V. (Claudiu) - [`185ac9f`](https://github.com/eea/volto-toolbar-actions/commit/185ac9f26ac3d5f4cc6994fbd30baaa87a70c811)]
## [3.0.0](https://github.com/eea/volto-toolbar-actions/compare/2.0.1...3.0.0) - 25 March 2026

#### :rocket: New Features

- feat: Volto 18 support - refs #287700 [Alin Voinea - [`e8634df`](https://github.com/eea/volto-toolbar-actions/commit/e8634df0d7b60c8f05b1371fb70232b050ebfd74)]

#### :house: Internal changes

- chore: [JENKINSFILE] add package version in sonarqube [valentinab25 - [`8274205`](https://github.com/eea/volto-toolbar-actions/commit/8274205e003bcdbb0c135a0e514986866ad53a82)]
- chore: [JENKINSFILE] use sonarqube branches [EEA Jenkins - [`6f893c1`](https://github.com/eea/volto-toolbar-actions/commit/6f893c154204d619b40ada386d4e8c35a8025107)]
- chore: package.json [alin - [`1eef372`](https://github.com/eea/volto-toolbar-actions/commit/1eef3720b6ad0ebf416b2ef2d8965325dbb660f1)]

#### :hammer_and_wrench: Others

- tests: Fix Sonar Qube tags - refs #297339 [Alin Voinea - [`0143964`](https://github.com/eea/volto-toolbar-actions/commit/01439640a2a8905696decead28870b17115b46fb)]
- Add Sonarqube tag using clms-frontend addons list [EEA Jenkins - [`92d6746`](https://github.com/eea/volto-toolbar-actions/commit/92d674640b3fbf9b36fdf3754375bf0a10ef1f54)]
- Add Sonarqube tag using clms-frontend addons list [EEA Jenkins - [`d799fb7`](https://github.com/eea/volto-toolbar-actions/commit/d799fb7c54a2bb81e713ee265453fb0d605ae6f5)]
- Add Sonarqube tag using eea-website-frontend addons list [EEA Jenkins - [`1a835d8`](https://github.com/eea/volto-toolbar-actions/commit/1a835d8b91afdbc2905f5105dfff9562013b5ae6)]
- Add Sonarqube tag using eea-website-frontend addons list [EEA Jenkins - [`6b9457a`](https://github.com/eea/volto-toolbar-actions/commit/6b9457a397f2560f54ecdee1b4f6aab82c37b404)]
- Add Sonarqube tag using clms-frontend addons list [EEA Jenkins - [`3bcf802`](https://github.com/eea/volto-toolbar-actions/commit/3bcf80286b5a14c184ddb53e483547fb2f7e59d9)]
- Add Sonarqube tag using ied-frontend addons list [EEA Jenkins - [`f7a8ba5`](https://github.com/eea/volto-toolbar-actions/commit/f7a8ba5313959144b825129d940aed79968ed116)]
- Add Sonarqube tag using industry-frontend addons list [EEA Jenkins - [`8fc888e`](https://github.com/eea/volto-toolbar-actions/commit/8fc888e5eb27ace213f86a76a46ccccf1601368b)]
- Add Sonarqube tag using forests-frontend addons list [EEA Jenkins - [`fce93a6`](https://github.com/eea/volto-toolbar-actions/commit/fce93a68c77d7ee2d1c50b819db813afe53abe7b)]
